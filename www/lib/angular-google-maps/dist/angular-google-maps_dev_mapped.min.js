...
!function (a, b, c) {
    ...
    (function () {
        ...
        b.module("uiGmapgoogle-maps.directives.api.utils").service("uiGmap_sync", [function () {
            ...
            return w = c.promiseTypes, p = c.isInProgress, v = c.promiseStatus, h = c.ExposedPromise, j = c.SniffedPromise, q = function (a, b) {
                var c;
                return c = a.promise(), c.promiseType = a.promiseType, c.$$state && d.debug("promiseType: " + c.promiseType + ", state: " + v(c.$$state.status)), c.cancelCb = b, c
            }, m = function (a, b) {
                return a.promiseType === w.create && b.promiseType !== w["delete"] && b.promiseType !== w.init ? (d.debug("lastPromise.promiseType " + b.promiseType + ", newPromiseType: " + a.promiseType + ", SKIPPED MUST COME AFTER DELETE ONLY"), !0) : !1
            }, u = function (a, b, c) {
                var e;
                return b.promiseType === w["delete"] && c.promiseType !== w["delete"] && null != c.cancelCb && _.isFunction(c.cancelCb) && p(c) && (d.debug("promiseType: " + b.promiseType + ", CANCELING LAST PROMISE type: " + c.promiseType), c.cancelCb("cancel safe"), e = a.peek(), null != e && p(e)) ? e.hasOwnProperty("cancelCb") && _.isFunction(e.cancelCb) ? (d.debug("promiseType: " + e.promiseType + ", CANCELING FIRST PROMISE type: " + e.promiseType), e.cancelCb("cancel safe")) : d.warn("first promise was not cancelable") : void 0
            }, i = function (a, b, c) {
                var d, e;
                if (a.existingPieces) {
                    if (d = _.last(a.existingPieces._content), m(b, d))return;
                    return u(a.existingPieces, b, d), e = h(d["finally"](function () {
                        return q(b, c)
                    })), e.cancelCb = c, e.promiseType = b.promiseType, a.existingPieces.enqueue(e), d["finally"](function () {
                        return a.existingPieces.dequeue()
                    })
                }
                return a.existingPieces = new f.Queue, a.existingPieces.enqueue(q(b, c))
            }, s = function (a, b, c, e, f) {
                var g;
                return null == c && (c = ""), g = function (a) {
                    return d.debug("" + a + ": " + a), e(a)
                }, i(a, j(f, b), g)
            }, k = 80, o = {value: null}, x = function (a, b, c) {
                var d;
                try {
                    return a.apply(b, c)
                } catch (e) {
                ...
                var f, g;
                return g = x(a, b, e), g === o && (f = "error within chunking iterator: " + o.value, d.error(f), c.reject(f)), "cancel safe" === g ? !1 : !0
            }, z = function (a, b, c) {
                var d, e;
                ...
                return y(c, j, function (j, k) {
                    var m, n, o, p;
                    for (m = d && d < j.length ? d : j.length, n = i, o = !0; o && m-- && n < (j ? j.length : n + 1);)p = z(c, j, n), o = b.isFunction(p) ? !0 : r(f, void 0, h, [p, n]), ++n;
                    if (j) {
                        if (!(o && n < j.length))return h.resolve();
                        if (i = n, d)return null != g && _.isFunction(g) && r(g, void 0, h, []), a(function () {
                ...
                var j, m, n;
                return null == e && (e = k), null == g && (g = 0), null == h && (h = 1), n = void 0, m = c.defer(), n = m.promise, h ? y(a, i, function () {
                    return m.resolve(), n
                }, function (c, d) {
                    return l(a, e, h, b, f, m, g, d), n
                }) : (j = "pause (delay) must be set from _async!", d.error(j), m.reject(j), n)
            }, t = function (a, b, d, e, f, g, h) {
                var i;
                return i = [], y(a, h, function () {
                    return c.resolve(i)
                }, function (c, h) {
        ...
        b.module("uiGmapgoogle-maps.directives.api.utils").factory("uiGmapModelKey", ["uiGmapBaseObject", "uiGmapGmapUtil", "uiGmapPromise", "$q", "$timeout", function (c, e) {
            var f;
            return f = function (c) {
                function f(b) {
                ...
                return d(f, c), f.prototype.evalModelHandle = function (a, b) {
        ...
        b.module("uiGmapgoogle-maps.directives.api.options.builders").factory("uiGmapPolylineOptionsBuilder", ["uiGmapCommonOptionsBuilder", function (a) {
            ...
            return b = function (a) {
                ...
                return c(b, a), b.prototype.buildOpts = function (a, c) {
                    return b.__super__.buildOpts.call(this, {path: a}, c, {geodesic: !1})
                }, b
            }(a)
            ...
            return d = function (a) {
                ...
                return c(d, a), d.prototype.buildOpts = function (a, c, e) {
                    var f, g;
            ...
            return b = function (a) {
                ...
                return c(b, a), b.prototype.buildOpts = function (a, c, d) {
                ...
                return i = function (c) {
                    function i(c, d, g, i, j) {
                        ...
                        this.scope = c, this.attrs = d, this.map = g, this.defaults = i, this.model = j, this.clean = a(this.clean, this), this.clonedModel = _.clone(this.model, !0), this.isDragging = !1, this.internalEvents = {
                            ...
                            return function () {
                                var d, i;
                                if (!a.isDragging)return i = a.convertPathPoints(a.scope.path), null != a.gObject && a.clean(), null != c.model && (d = c), i.length > 0 && (a.gObject = e(a.buildOpts(i, d))), a.gObject ? (a.scope.fit && a.extendMapBounds(g, i), f(a.gObject.getPath(), a.scope, "path", function (b) {
                                    return a.scope.fit ? a.extendMapBounds(g, b) : void 0
                                }), b.isDefined(c.events) && b.isObject(c.events) && (a.listeners = a.model ? h.setEvents(a.gObject, a.scope, a.model) : h.setEvents(a.gObject, a.scope, a.scope)), a.internalListeners = a.model ? h.setEvents(a.gObject, {events: a.internalEvents}, a.model) : h.setEvents(a.gObject, {events: a.internalEvents}, a.scope)) : void 0
                            }
                    ...
                    return d(i, c), i.include(g), i.prototype.clean = function () {
                        var a;
                ...
                return d(l, b), l.include(c), l.include(f), l.include(h), m = function (a) {
                    ...
                    if (null == b && (b = !0), !this.isNotValid(a, !1)) {
                        if (this.renderGMarker(b, function (a) {
                                return function () {
                                    var b, c, d;
                                    return b = a.getProp(a.coordsKey, a.model), c = a.getProp(a.iconKey, a.model), d = a.getProp(a.optionsKey, a.model), a.opts = a.createOptions(b, c, d), a.isLabel(a.gObject) !== a.isLabel(a.opts) && null != a.gObject && (a.gManager.remove(a.gObject), a.gObject = void 0), null != a.gObject && a.gObject.setOptions(a.setLabelOptions(a.opts)), a.gObject || (a.gObject = a.isLabel(a.opts) ? new MarkerWithLabel(a.setLabelOptions(a.opts)) : new google.maps.Marker(a.opts), _.extend(a.gObject, {model: a.model})), a.externalListeners && a.removeEvents(a.externalListeners), a.internalListeners && a.removeEvents(a.internalListeners), a.externalListeners = a.setEvents(a.gObject, a.scope, a.model, ["dragend"]), a.internalListeners = a.setEvents(a.gObject, {
        ...
        b.module("uiGmapgoogle-maps.directives.api.models.child").factory("uiGmapWindowChildModel", ["uiGmapBaseObject", "uiGmapGmapUtil", "uiGmapLogger", "$compile", "$http", "$templateCache", "uiGmapChromeFixes", "uiGmapEventsHelper", function (d, f, g, h, i, j, k, l) {
            ...
            return m = function (d) {
                ...
                return e(m, d), m.include(f), m.include(l), m.prototype.doShow = function (a) {
        ...
        b.module("uiGmapgoogle-maps.directives.api.models.parent").factory("uiGmapBasePolysParentModel", ["$timeout", "uiGmapLogger", "uiGmapModelKey", "uiGmapModelsWatcher", "uiGmapPropMap", "uiGmap_async", "uiGmapPromise", function (c, e, f, g, h, i, j) {
            return function (c, k, l) {
                ...
                return m = function (f) {
                    ...
                    return d(m, f), m.include(g), m.prototype.watchModels = function (a) {
                        ...
                        var d, e;
                        return e = this.scope.$new(!1), this.setChildScope(c.scopeKeys, e, a), e.$watch("model", function (a) {
                            return function (b, c) {
                                return b !== c ? a.setChildScope(e, b) : void 0
                            }
                        }(this), !0), e["static"] = this.scope["static"], d = new k(e, this.attrs, b, this.defaults, a), null == a[this.idKey] ? void this.$log.error("" + l + " model has no id to assign a child to.\nThis is required for performance. Please assign id,\nor redirect id to a different key.") : (this.plurals.put(a[this.idKey], d), d)
                    }, m
                }(f)
            }
        }])
        ...
        b.module("uiGmapgoogle-maps.directives.api.models.parent").factory("uiGmapCircleParentModel", ["uiGmapLogger", "$timeout", "uiGmapGmapUtil", "uiGmapEventsHelper", "uiGmapCircleOptionsBuilder", function (a, d, e, f, g) {
            ...
            return h = function (d) {
                function g(c, d, f, g, h) {
                    var i, j, k;
                    this.scope = c, this.attrs = f, this.map = g, this.DEFAULTS = h, k = null, i = function (a) {
                        return function () {
                            return k = null, null != a.listeners ? (a.removeEvents(a.listeners), a.listeners = void 0) : void 0
                        }
                    }(this), j = new google.maps.Circle(this.buildOpts(e.getCoords(c.center), c.radius)), this.setMyOptions = function (a) {
                        return function (b, d) {
                        ...
                        prop: "fill",
                        isColl: !0
                    }, "radius", "zIndex"]), this.watchProps(), i(), this.listeners = this.setEvents(j, c, c, ["radius_changed"]), null != this.listeners && this.listeners.push(google.maps.event.addListener(j, "radius_changed", function () {
                        var a, d;
                        return a = j.getRadius(), a !== k ? (k = a, d = function () {
                            var b, d;
                            return a !== c.radius && (c.radius = a), (null != (b = c.events) ? b.radius_changed : void 0) && _.isFunction(null != (d = c.events) ? d.radius_changed : void 0) ? c.events.radius_changed(j, "radius_changed", c, arguments) : void 0
                        }, b.mock ? d() : c.$evalAsync(function () {
                            return d()
                        })) : void 0
                        ...
                        return c.$evalAsync(function () {
                            return b.isDefined(c.center.type) ? (c.center.coordinates[1] = j.getCenter().lat(), c.center.coordinates[0] = j.getCenter().lng()) : (c.center.latitude = j.getCenter().lat(),
        ...
        b.module("uiGmapgoogle-maps.directives.api.models.parent").factory("uiGmapDrawingManagerParentModel", ["uiGmapLogger", "$timeout", "uiGmapBaseObject", "uiGmapEventsHelper", function (a, b, d, e) {
            var f;
            return f = function (a) {
                function b(a, b, c, d) {
                    var e, f;
                    ...
                    }, !0), null != this.scope.events && (f = this.setEvents(e, this.scope, this.scope), a.$watch("events", function (a) {
                        return function (b, c) {
        ...
        b.module("uiGmapgoogle-maps.directives.api.models.parent").factory("uiGmapMarkersParentModel", ["uiGmapIMarkerParentModel", "uiGmapModelsWatcher", "uiGmapPropMap", "uiGmapMarkerChildModel", "uiGmap_async", "uiGmapClustererMarkerManager", "uiGmapMarkerManager", "$timeout", "uiGmapIMarker", "uiGmapPromise", "uiGmapGmapUtil", "uiGmapLogger", function (c, e, f, g, h, i, j, k, l, m, n) {
            ...
            return p = function (a, b) {
                ...
                function k(b, c, d, e) {
                    ...
                    var g;
                    k.__super__.constructor.call(this, b, c, d, e), this["interface"] = l, g = this, p(new f, this), this.scope.pluralsUpdate = {updateCtr: 0}, this.$log.info(this), this.doRebuildAll = null != this.scope.doRebuildAll ? this.scope.doRebuildAll : !1, this.setIdKey(b), this.scope.$watch("doRebuildAll", function (a) {
                        return function (b, c) {
                    ...
                    }(this), !this.isTrue(d.modelsbyref)), this.watch("doCluster", b), this.watch("clusterOptions", b), this.watch("clusterEvents", b), this.watch("fit", b), this.watch("idKey", b), this.gManager = void 0, this.createAllNew(b)
                }
                ...
                return d(k, c), k.include(n), k.include(e), k.prototype.onWatch = function (a, b, c, d) {
                    ...
                    var c, d, e, f, g;
                    return null != this.gManager && (this.gManager.clear(), delete this.gManager), a.doCluster ? (a.clusterEvents && (d = this, this.origClusterEvents ? b.extend(a.clusterEvents, this.origClusterEvents) : this.origClusterEvents = {
                        click: null != (e = a.clusterEvents) ? e.click : void 0,
                        mouseout: null != (f = a.clusterEvents) ? f.mouseout : void 0,
                        mouseover: null != (g = a.clusterEvents) ? g.mouseover : void 0
        ...
        b.module("uiGmapgoogle-maps.directives.api.models.parent").factory("uiGmapRectangleParentModel", ["uiGmapLogger", "uiGmapGmapUtil", "uiGmapEventsHelper", "uiGmapRectangleOptionsBuilder", function (a, b, d, e) {
            ...
            return f = function (e) {
                function f(b, c, d, e, f) {
                    ...
                    this.scope = b, this.attrs = d, this.map = e, this.DEFAULTS = f, g = void 0, j = !1, o = [], n = void 0, k = function (a) {
                        return function () {
                    ...
                    }(this), null != g && m(), b.$watch("bounds", function (a, b) {
                        var c;
                    ...
                    }(this), this.props.push("bounds"), this.watchProps(this.props), null != d.events && (n = this.setEvents(l, b, b), b.$watch("events", function (a) {
                        return function (c, d) {
                            return _.isEqual(c, d) ? void 0 : (null != n && a.removeEvents(n), n = a.setEvents(l, b, b))
                        }
        ...
        b.module("uiGmapgoogle-maps.directives.api.models.parent").factory("uiGmapWindowsParentModel", ["uiGmapIWindowParentModel", "uiGmapModelsWatcher", "uiGmapPropMap", "uiGmapWindowChildModel", "uiGmapLinked", "uiGmap_async", "uiGmapLogger", "$timeout", "$compile", "$http", "$templateCache", "$interpolate", "uiGmapPromise", "uiGmapIWindow", "uiGmapGmapUtil", function (c, e, f, g, h, i, j, k, l, m, n, o, p, q, r) {
            ...
            return s = function (c) {
                ...
                return d(s, c), s.include(e), s.prototype.go = function (a) {
        ...
        b.module("uiGmapgoogle-maps.directives.api").factory("uiGmapIMarker", ["uiGmapBaseObject", "uiGmapCtrlHandle", function (a, b) {
            ...
            return d = function (a) {
                ...
                return c(d, a), d.scope = {
                    ...
                    idKey: "=idkey",
                    control: "=control"
                }, d.scopeKeys = _.keys(d.scope), d.keys = d.scopeKeys, d.extend(b), d
            }(a)
        }])
    }.call(this), function () {
        var a = {}.hasOwnProperty, c = function (b, c) {
        ...
        b.module("uiGmapgoogle-maps.directives.api").factory("uiGmapIPolygon", ["uiGmapGmapUtil", "uiGmapBaseObject", "uiGmapLogger", "uiGmapCtrlHandle", function (a, b, d, e) {
            ...
            return f = function (b) {
                ...
                return c(f, b), f.scope = {
                    ...
                    fit: "=",
                    control: "=control"
                }, f.scopeKeys = _.keys(f.scope), f.include(a), f.extend(e), f.prototype.restrict = "EMA", f.prototype.replace = !0, f.prototype.require = "^uiGmapGoogleMap", f.prototype.scope = f.scope, f.prototype.DEFAULTS = {}, f.prototype.$log = d, f
            }(b)
        }])
    }.call(this), function () {
        var a = {}.hasOwnProperty, c = function (b, c) {
        ...
        b.module("uiGmapgoogle-maps.directives.api").factory("uiGmapIWindow", ["uiGmapBaseObject", "uiGmapChildEvents", "uiGmapCtrlHandle", function (a, b, d) {
            ...
            return e = function (a) {
                ...
                return c(e, a), e.scope = {
                    ...
                    control: "=control",
                    show: "=show"
                }, e.scopeKeys = _.keys(e.scope), e.include(b), e.extend(d), e
            }(a)
        }])
    }.call(this), function () {
        var a = function (a, b) {
                ...
                return e(i, f), i.include(h), i.prototype.restrict = "EMA", i.prototype.transclude = !0, i.prototype.replace = !1, i.prototype.template = '<div class="angular-google-map"><div class="angular-google-map-container"></div><div ng-transclude style="display: none"></div></div>', i.prototype.scope = {
                    ...
                    return h = [], a.$on("$destroy", function () {
                        ...
                        return function (j) {
                            ...
                            if (r = {mapTypeId: j.MapTypeId.ROADMAP}, z = k.spawn(), x = function () {
                                    return z.deferred.resolve({instance: z.instance, map: D})
                            ...
                            if (p = b.element(e), p.addClass("angular-google-map"), w = {options: {}}, f.options && (w.options = a.options), f.styles && (w.styles = a.styles), f.type && (A = f.type.toUpperCase(), google.maps.MapTypeId.hasOwnProperty(A) ? w.mapTypeId = google.maps.MapTypeId[f.type.toUpperCase()] : g.error("angular-google-maps: invalid map type '" + f.type + "'")), u = b.extend({}, r, w, {
                                    center: i.getCoords(a.center),
                                    zoom: a.zoom,
                                    bounds: a.bounds
                                }), D = new google.maps.Map(p.find("div")[1], u), D.uiGmap_id = l.generate(), o = !1, h.push(google.maps.event.addListenerOnce(D, "idle", function () {
                                    return a.deferred.resolve(D), x()
                                })), n = f.events && null != (null != (E = a.events) ? E.blacklist : void 0) ? a.events.blacklist : [], _.isString(n) && (n = [n]), v = function (b, c, d) {
                                    return _.contains(n, b) ? void 0 : (d && d(), h.push(google.maps.event.addListener(D, b, function () {
                                        var b;
                                    ...
                                    if (null == c && (c = D.center), null == d && (d = a), !_.contains(n, "center"))if (b.isDefined(d.center.type)) {
                                    ...
                                    var b, d, e;
                                    return b = D.getBounds(), d = b.getNorthEast(), e = b.getSouthWest(), y = !0, a.$evalAsync(function (b) {
                                        return B(), null === b.bounds || b.bounds === c || void 0 === b.bounds || _.contains(n, "bounds") || (b.bounds.northeast = {
                                            latitude: d.lat(),
                                            longitude: d.lng()
                                        }, b.bounds.southwest = {
                                            latitude: e.lat(),
                                            longitude: e.lng()
                                        }), _.contains(n, "zoom") || (b.zoom = D.zoom, a.idleAndZoomChanged = !a.idleAndZoomChanged), y = !1
                                    })
                                })), b.isDefined(a.events) && null !== a.events && b.isObject(a.events)) {
                                t = function (b) {
                                    return function () {
                                        return a.events[b].apply(a, [D, b, arguments])
                                    }
                                }, m = [];
                                for (s in a.events)a.events.hasOwnProperty(s) && b.isFunction(a.events[s]) && m.push(google.maps.event.addListener(D, s, t(s)));
                                h.concat(m)
                            }
                            return D.getOptions = function () {
                                return u
                            }, a.map = D, null != f.control && null != a.control && (a.control.refresh = function (a) {
                                var b, c, d;
                                if (null != D)return null != ("undefined" != typeof google && null !== google && null != (c = google.maps) && null != (d = c.event) ? d.trigger : void 0) && null != D && google.maps.event.trigger(D, "resize"), null != (null != a ? a.latitude : void 0) && null != (null != a ? a.longitude : void 0) ? (b = i.getCoords(a), i.isTrue(f.pan) ? D.panTo(b) : D.setCenter(b)) : void 0
                                ...
                                var d, e;
                                if (b !== c && !y && (d = i.getCoords(a.center), d.lat() !== D.center.lat() || d.lng() !== D.center.lng()))return e = !0, o || (i.validateCoords(b) || g.error("Invalid center for newValue: " + JSON.stringify(b)), i.isTrue(f.pan) && a.zoom === D.zoom ? D.panTo(d) : D.setCenter(d)), e = !1
                            }, !0), C = null, a.$watch("zoom", function (b, c) {
                                var e, f, g;
                                if (null != b && !_.isEqual(b, c) && (null != D ? D.getZoom() : void 0) !== (null != a ? a.zoom : void 0) && !y)return e = !0, null != C && d.cancel(C), C = d(function () {
                                    return D.setZoom(b), e = !1
                                }, (null != (f = a.eventOpts) && null != (g = f.debounce) ? g.zoomMs : void 0) + 20, !1)
                            }), a.$watch("bounds", function (a, b) {
                                var c, d, e, f, h, i, j;
                                if (a !== b)return null == (null != a && null != (f = a.northeast) ? f.latitude : void 0) || null == (null != a && null != (h = a.northeast) ? h.longitude : void 0) || null == (null != a && null != (i = a.southwest) ? i.latitude : void 0) || null == (null != a && null != (j = a.southwest) ? j.longitude : void 0) ? void g.error("Invalid map bounds for new value: " + JSON.stringify(a)) : (d = new google.maps.LatLng(a.northeast.latitude, a.northeast.longitude), e = new google.maps.LatLng(a.southwest.latitude, a.southwest.longitude), c = new google.maps.LatLngBounds(e, d), D.fitBounds(c))
                            }), ["options", "styles"].forEach(function (b) {
                                return a.$watch(b, function (a, b) {
                                    var c;
                                    return c = this.exp, _.isEqual(a, b) ? void 0 : ("options" === c ? w.options = a : w.options[c] = a, null != D ? D.setOptions(w) : void 0)
                                }, !0)
                            })
                        }
                    }(this))
            ...
            return g = function (e) {
                ...
                return c(g, e), g.prototype.controller = ["$scope", "$element", function (b, c) {
                    ...
                    return h = void 0, i = function () {
                        ...
                        }), h = new d(c, e, f, a), b.link(c, h), null != c.control && (c.control.getGMarkers = function () {
                            var a;
        ...
        b.module("uiGmapgoogle-maps.directives.api").factory("uiGmapPolylines", ["uiGmapIPolyline", "$timeout", "uiGmaparray-sync", "uiGmapPolylinesParentModel", "uiGmapPlural", function (c, e, f, g, h) {
            var i;
            return i = function (c) {
                function e() {
                    this.link = a(this.link, this), e.__super__.constructor.call(this), h.extend(this), this.$log.info(this)
        ...
        b.module("uiGmapgoogle-maps.directives.api").factory("uiGmapWindows", ["uiGmapIWindow", "uiGmapPlural", "uiGmapWindowsParentModel", "uiGmapPromise", "uiGmapLogger", function (b, c, e, f, g) {
            ...
            return h = function (b) {
                ...
                return d(h, b), h.prototype.link = function (a, b, c, d) {
                    ...
                    var i;
                    return i = new e(a, b, d, f, g, h), c.link(a, i), null != a.control ? (a.control.getGWindows = function () {
                        return function () {
            ...
            init: _.once(function () {
                ...
                function h(a, b) {
                    this.marker_ = a, this.handCursorURL_ = a.handCursorURL, this.labelDiv_ = document.createElement("div"), this.labelDiv_.style.cssText = "position: absolute; overflow: hidden;", this.eventDiv_ = document.createElement("div"), this.eventDiv_.style.cssText = this.labelDiv_.style.cssText, this.eventDiv_.setAttribute("onselectstart", "return false;"),
                        this.eventDiv_.setAttribute("ondragstart", "return false;"), this.crossDiv_ = h.getSharedCross(b)
                }
